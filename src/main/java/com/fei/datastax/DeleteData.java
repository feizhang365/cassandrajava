...
/**
 * <p>
 *   delete data from a table using the command <i>DELETE</i> in Cassandra using Java API
...
public class DeleteData {
    public static void main(String[] args){
        String deleteSql = "DELETE FROM emp WHERE emp_id=3;" ;
        ...
        System.out.println("Data deleted in Table");
        session.close();
    }
}
