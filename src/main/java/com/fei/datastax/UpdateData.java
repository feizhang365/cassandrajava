...
/**
 * <p>
 *   UPDATE is the command used to update data in a table in Cassandra using Java API
...
public class UpdateData {
    public static void main(String[] args){
        String updateSql = "UPDATE emp SET emp_city='Delhi',emp_sal=50000 where emp_id=1" ;
